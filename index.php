...
<form method="post" action="/src/model/forms/adiciona_mercadoria.php">
...
<table border="1">
    ...
    <?php require_once 'src/model/dao/mercadoria_dao.php'; ?>
    ...
    foreach ($result as $row) {
        ...
        <?php print "<tr>
            ...
            "<form method=\"post\" action=\"src/model/forms/functions.php\">
            <td>
